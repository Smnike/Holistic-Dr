...
class Doctor extends Component {
  ...
  // handleSubmit (e) {
    ...
    return (
      <div>
        <h1>Holistic Doctor<br/> near me</h1>
        <input type="text" name="zip-code" placeholder="Zip Code"/> <button onClick={this.handleSubmit}><a href="">Check Near Me</a></button>
        ...
        this.state.doctors.map((pract, index) => {
          return <li key={index}>{pract.name} Street: {pract.visit_addres}</li>
          console.log(pract)
        })
      }
      </div>
